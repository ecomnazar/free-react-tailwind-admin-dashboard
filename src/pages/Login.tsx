...
import { IAdmin } from '../shared/lib/interfaces';
import { setAdminLS } from '../shared/lib/localstorage';
import { useNavigate } from 'react-router-dom';

interface ILoginResponse {
  data: { access_token: string; admin: IAdmin };
}
...
export const Login = () => {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    const response: ILoginResponse = await toast.promise(
      instance.post(API_ENDPOINTS.LOGIN, data),
      {
        loading: 'Loading',
        error: 'Login failed',
        success: 'Success',
  ...
  return (
    <>
      ...
      <div className="w-screen h-screen flex items-center justify-center">
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark max-w-[1200px]">
