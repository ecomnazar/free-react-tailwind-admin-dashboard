...
const PhoneCodesEdit = () => {
  ...
  React.useEffect(() => {
    const getPhoneCodeById = async () => {
      const response = await instance.get(`${API_ENDPOINTS.PHONE_CODES}/${id}`);
  ...
  return (
    <>
      <Breadcrumb pageName="Edit phone code" />
